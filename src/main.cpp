...
#define _SSID "HOME"      // Your WiFi SSID
#define _PASSWORD "T20030617"  // Your WiFi Password
#define KEY "HELLO"        // Webhooks Key
#define EVENT "HELLO Event"      // Webhooks Event Name
